...
export default function TesIndex(props: TesPageProps) {
    ...
    const onTabChange = (value: string) => {
        if (value === "validation") {
            ...
            router.visit(route("admin.tes.validation.index"));
        } else {
                ...
                <div className="space-y-4">
                    <Tabs defaultValue={ziggy.query.tab || "hei"} onValueChange={onTabChange}>
                        ...
                        <TabsContent value="hei">
                            <TesHeiGrid paginatedHeis={paginatedHeis} filters={filters} batches={batches} />
                        </TabsContent>
        ...
        filters={filters_db}
                    ...
                    cities={cities}
                        ...
                        <TabsContent value="masterlist">
                            <TesMasterlistGrid
                                records={ml_tes}
                                filters={filters} // ✅ Correct: Pass global filters here
                                academicYears={academicYears}
                                semesters={semesters}
                                batches={batches}
                                heiList={heiList}
