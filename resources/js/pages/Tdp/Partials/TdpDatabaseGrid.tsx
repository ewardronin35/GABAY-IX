...
const mapDataToGrid = (records: any[]) => {
    ...
    return records.map((record) => {
        ...
        return {
            ...
            // ✅ ADDED ELIGIBILITY
            eligibility_equivalent: record.eligibility_equivalent || 0.5,
...
export function TdpDatabaseGrid({
    ...
    const columns = useMemo(() => [
        ...
        { data: 'student_id', title: 'Student ID' }, // ✅ Added Column
        ...
        { data: 'eligibility_equivalent', title: 'Eligibility' }, // ✅ Added Column
    ...
    const handleSave = useCallback(() => {
        ...
        const cleanedData = rawData.filter((row: any) => {
            ...
            return {
                ...
                // Ensure new fields are passed cleanly
                student_id: row.student_id ? String(row.student_id) : null,
                eligibility_equivalent: cleanNumber(row.eligibility_equivalent),
            };
        });
        ...
        setIsSaving(true);
        router.post(route('admin.tdp.bulk-update'), { enrollments: cleanedData }, {
            preserveScroll: true,
            onSuccess: () => { 
    ...
    const handleDelete = () => {
        ...
        setIsDeleting(true);
        router.post(route('admin.tdp.bulk-destroy'), { ids: selectedIds }, {
            preserveScroll: true,
            onSuccess: () => { 
    ...
    const handleSheetChange = (value: string) => {
        ...
        router.get(route('admin.tdp.index'), { ...filters, [filterKey]: value }, {
